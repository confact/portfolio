    ...
    <div>
      ...
      <main className="px-3 md:px-0 max-w-3xl mx-auto py-6 font-light">
        ...
        <div className="flex flex-col gap-3">
          ...
          <p>My current sideproject is <a href="https://www.errordeck.com">Errordeck - Error tracking and monitoring</a>. It is simple an european and more privacy friendly alternative to Sentry, Rollbar, Raygun and Airbrake.</p>
